...
public class VisitMapperTest {
    ...
    public static Stream<Arguments> correctVisitData() {
        Doctor doctor = createDoctor(1L, "Mariusz", "Kowalski", "chirurg",
                "123456789", new ArrayList<>());
        Doctor doctor2 = createDoctor(1L, null, null, null, null, null);
        Patient patient = createPatient(1L, "Andrzej", "Kielbasa", "123456789",
                "12345", LocalDate.of(1998, 10, 10));
        Institution institution = createInstitution(1L, "NFZ", "Warszawa", null);
        Institution institution2 = createInstitution(null, "NFZ", "Warszawa", null);
        Visit visit1 = createVisit(1L, CREATED, BigDecimal.valueOf(150),
                LocalDateTime.of(2024, 10, 10, 15, 15),
                LocalDateTime.of(2024, 10, 10, 16, 0), doctor, patient, institution);
        Visit visit2 = createVisit(1L, CREATED, BigDecimal.valueOf(150),
                LocalDateTime.of(2024, 10, 10, 15, 15),
                LocalDateTime.of(2024, 10, 10, 16, 0), doctor, patient, institution2);
        Visit visit3 = createVisit(1L, CREATED, BigDecimal.valueOf(150),
                LocalDateTime.of(2024, 10, 10, 15, 15),
                LocalDateTime.of(2024, 10, 10, 16, 0), doctor, null, institution);
        Visit visit4 = createVisit(1L, CREATED, BigDecimal.valueOf(150),
                LocalDateTime.of(2024, 10, 10, 15, 15),
