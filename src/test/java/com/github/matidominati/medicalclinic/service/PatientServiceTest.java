...
//    @BeforeEach
//    void setup() {
//        this.createPatientCommand = Mockito.mock(CreatePatientCommand.class);
//        this.patientRepository = Mockito.mock(PatientRepository.class);
//        this.patientMapper = Mappers.getMapper(PatientMapper.class);
//        this.userRepository = Mockito.mock(UserRepository.class);
//        this.patientService = new PatientService(patientRepository, patientMapper, userRepository, createPatientCommand);
//    }
//
//    @Test
...
//        patientCommand.setPhoneNumber("123-456-789");
...
//
//        when(patientRepository.findById(patientOriginal.getId())).thenReturn(Optional.of(patientOriginal));
//        when(createPatientCommand.isPasswordValid(patientUpdatedData.getPassword())).thenReturn(true);
//
//        patientService.changePassword(patientOriginal.getId(), patientUpdatedData);
//
//        verify(createPatientCommand, times(1)).isPasswordValid(patientUpdatedData.getPassword());
//        verify(patientRepository).save(patientOriginal);
//    }
//
//    @Test
