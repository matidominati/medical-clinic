...
//    @BeforeEach
//    void setup() {
//        this.dataValidator = Mockito.mock(crudValidator.class);
...
//        patientCommand.setEmail("andrzej.golota@gmail.com");
//
//        when(userRepository.findByEmail(patientCommand.getEmail())).thenReturn(Optional.of(new UserData()));
//
...
//        assertEquals("UserData with given email exist", exception.getMessage());
//    }
//
//    @Test
...
//
//        assertEquals("The patient with the given ID does not exist in the database", exception.getMessage());
//    }
//
//    @Test
...
//
//        when(patientRepository.findById(patientOriginal.getId())).thenReturn(Optional.of(patientOriginal));
//        when(crudValidator.isPasswordValid(patientUpdatedData.getPassword(), patientUpdatedData.getFirstName(), patientUpdatedData.getLastName())).thenReturn(true);
//
